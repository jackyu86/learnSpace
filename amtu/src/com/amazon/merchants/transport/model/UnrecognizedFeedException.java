...
public class UnrecognizedFeedException extends MerchantException {
	 ...
	 * @param exceptionText
	 */
	public UnrecognizedFeedException(String exceptionText)
	{
		super(exceptionText);
	}
	 ...
	 * @param rootException
	 */
	public UnrecognizedFeedException(Throwable rootException)
	{
		super(rootException);
	}
